...
public class CreatingVariables {
    ...
    public static void main(String[] args) {
        ...
        CreatingVariables bicicleta1 = new CreatingVariables();
        CreatingVariables bicicleta2 = new CreatingVariables();
        
        // Modificación de variables de instancia
        bicicleta1.speed = 10;
        bicicleta2.speed = 20;
        
        System.out.println("Bicycle1 speed: " + bicicleta1.speed);
        System.out.println("Bicycle2 speed: " + bicicleta2.speed);
        
        // Uso de variable de clase (compartida entre todas las instancias)
        System.out.println("Number of gears: " + CreatingVariables.numGears);
        
        // Llamada a método que usa variable local y parámetro
        bicicleta1.changeGear(3);
    }
}
